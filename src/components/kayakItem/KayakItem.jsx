...
const KayakItem = ({ nameItem, descriptionItem, image }) => {
    return (
        <div className="lg:h-39 max-w-sm w-full lg:max-w-full lg:flex rounded-xl overflow-hidden shadow-xl bg-gray-250 m-2">
            <div 
                ...
                <img
                    src={image}
                    alt={nameItem}
                    className="h-full sm:w-full flex-none rounded-l-xl"
                />
            </div>
