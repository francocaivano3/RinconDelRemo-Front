...
const AddKayakModal = ({ isOpen, onClose, onAddKayak }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-[#003459] rounded-2xl shadow-xl w-full max-w-4xl z-10 overflow-hidden"
      ...
      >
        ...
        <form onSubmit={handleSumbit} className="p-5">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div>
              <label className="flex items-center text-sm font-medium text-gray-700 dark:text-white mb-1">
                Fecha de compra{" "}
                <svg
                  className="h-5 w-6 ml-2 text-white"
                  viewBox="0 0 24 24"
                  fill="none"
